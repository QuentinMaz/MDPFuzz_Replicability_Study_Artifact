...
class fuzzing:
    ...
    def mutate(self, orig_acas_speed, orig_x2, orig_y2, orig_auto_theta):
        ...
        self.current_pose = [new_acas_speed, new_x2, new_y2, new_auto_theta]
